"""
Face2Comics dataset in torchmanager dataset.
...
from .split import DatasetSplit as Face2ComicsSplit


class Face2Comics(Dataset):
    """
    Dataset for the face2comics dataset.
    ...
    def __init__(self, path: str, batch_size: int, /, img_size: Union[int, tuple[int, int]], *, device: Optional[torch.device] = None, drop_last: bool = False, num_workers: Optional[int] = None, repeat: int = 1, return_file_name: bool = False, shuffle: bool = False, split: Face2ComicsSplit = Face2ComicsSplit.TRAIN):
        """
        Constructor
        ...
        transforms_list: list[Callable[..., tuple[Any, Any]]] = [transforms.RandomHorizontalFlip(p=0)] if split == Face2ComicsSplit.TRAIN else []
